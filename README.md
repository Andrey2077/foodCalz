foodCalz — бэкенд-сервис учёта питания и калорий «как FatSecret»: поиск продуктов и блюд, добавление порций в дневник, подсчёт КБЖУ по дню/неделе/месяцу, цели (калории/макросы), рецепты, избранное.
